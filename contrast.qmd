...
With that information we can proceed with our whether the mean of manual brushes is equal to the mean of oscillating brushes. Plugging the values from @tbl-brush_analysis into @eq-diff2means we can calculate the t statistic:
