...
![Farmer John's Subsamples](images/FarmerJohnsSubsamples.PNG){fig-align="center" width="500"}
...
That's not to say sub-samples are useless. They can provide useful information about how yields vary within a plot, but they are not replications of the experiment. It can be so tempting to believe we have 20 independent observations more statistical power than the actual design allows (which is zero). It can only provide a false sense of statistical sophistication for a simple anecdote.
