...
![Farmer John's Subsamples](images/FarmerJohnsSubsamples.PNG){fig-align="center" width="1096"}
...
This model only works, though, if you have treatment replications, k, otherwise you cannot estimate the error term, $ e_\text{ijk} $.
