...
# Testimonials about Design and Analysis of Experiments

> "Math326 \[Design and Analysis of Experiments\] was fundamental in preparing me for my doctorate. The course covered many topics (and covered them well) from my early graduate-level statistics courses and prepared me well for more advanced courses. Despite taking the course in 2019, I still recall (and use the knowledge from!) lectures. In fact, I recently referenced the lectures on ordering experimental treatments. \[The teachers\] excel in breaking down content into simple yet complete explanations. I highly recommend this course for anyone interested in advancing their statistical and research skillset, particularly if they are interested in a data- or science-focused career.

\~Spencer Garcia, Industrial Organizational Psychology Ph.D. student at Georgia Institute of Technology (2025)

------------------------------------------------------------------------

"If you have room for this class in your schedule, I highly recommend taking \[Design and Analysis of Experiments\]. I graduated \[from BYU-Idaho\] in 2020 and still use the knowledge I gained from this class in my graduate program and research. The projects and homework, though difficult, are hands-on and helpful in learning the different designs. The designs apply to several fields (e.g., psychology) and types of analyses. The statistics knowledge (e.g., ANOVA) and software skills (e.g., R, Excel) transfer to other statistics classes. I wanted to retake this class last year and take better notes to help with my current work; I strongly suggest taking this class when you still can!

\~Amanda Stephens, Industrial Organizational Psychology Ph.D. student at Oklahoma University (2025)
...
2.  Read the pages under the Basics of Design menu in order

3.  Read the following pages in order under "Broad Topics" menu: Factor Structure through Assumptions

4.  Read Basic Factorial Introduction and BF\[1\] under Specific Designs menu

5.  Pages under the R Instructions menu can act as a resource. They may fit well as a review here

6.  Under Broad Topics menu Read Contrasts and Multiple Comparisons

7.  Read BF\[2\] under Specific Design menu

8.  Read Unbalanced Datasets under Broad Topics menu
