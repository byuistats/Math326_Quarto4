...
<br/> The p-value for `Oscillating - Ultrasonic` is 0.0031 and is the only significant pairwise comparison at the 0.05 level; though `Manual - Oscillating` is close, with a p-value of 0.0632.
