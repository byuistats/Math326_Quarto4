...
Now that the model is created the assumptions need to be checked. Code and explanation for assumption checking can be found in the [R Instructions-\>Model Assumptions](assumptions.qmd) section of the book.
