---
title: "Types of Factors and Types of Variance"
---

# Types of Factors

Once the response variable is determined, it is important to identify all possible factors that could influence the data measurements. Factors are often referred to as explanatory variables because they explain the variation in the response variable. They are also called independent variables since the response variable is thought to depend on the value of the factor. For each factor you identify, determine how you want it to influence your experiment:

-   Factors that you will be controlling and purposefully varying during the experiment.

-   Factors that will be held constant.

-   Factors that you cannot control. This group should be further categorized as

    -   Factors than will be measured (but not controlled)

    -   Factors that can/will not be measured nor controlled.

Each of these types of factors are discussed in further detail.
...
3)  the unexplained variation, commonly thought of as "random noise" or "random error".
...
The **unexplained variation** considers all the variability in the response that is not explained by the controlled and/or measured factors in the analysis. This variation is due to factors that are not known, not measured, and not controlled. *If sufficient randomization has taken place in the experiment we generally assume that unexplained variation behaves randomly, without bias.*
